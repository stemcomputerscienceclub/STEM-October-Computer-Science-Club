...
import { ArrowRight, Users, BookOpen, Code } from 'lucide-react'
    ...
    <section id="home" className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="container mx-auto px-4 text-center relative z-10">
        ...
        >
          ...
          >
            Welcome to{' '}
            <span className="gradient-text">STEM Computer Science Club</span>
          </motion.h1>
          ...
          >
            {stats.map((stat, index) => (
              <motion.div
                ...
                className="glass-effect rounded-xl p-6 text-center group hover:scale-105 transition-transform"
              >
