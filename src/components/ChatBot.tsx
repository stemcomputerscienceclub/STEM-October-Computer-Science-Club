  ...
  return (
    <>
      ...
      <motion.button
        ...
        className={`fixed bottom-6 right-6 z-50 p-4 bg-gradient-to-r from-primary-600 to-primary-700 hover:from-primary-700 hover:to-primary-800 text-white rounded-full shadow-lg hover:shadow-xl transition-all duration-300 ${
          isOpen ? 'hidden' : 'block'
        }`}
      ...
      <AnimatePresence>
        {isOpen && (
          <motion.div
            ...
            className="fixed bottom-6 right-6 z-50 w-96 h-[500px] bg-white dark:bg-secondary-900 rounded-lg shadow-2xl border border-secondary-200 dark:border-secondary-700 flex flex-col overflow-hidden"
          >
            {/* Header */}
            <div className="bg-gradient-to-r from-primary-600 to-primary-700 text-white p-4 flex items-center justify-between">
              <div className="flex items-center space-x-3">
                ...
                <div>
                  <h3 className="font-semibold">Codey - Club Mascot</h3>
                  <p className="text-xs opacity-90">Your friendly C-shaped coding buddy!</p>
                </div>
              </div>
              <motion.button
                whileHover={{ scale: 1.1 }}
                ...
                >
                  <div className={`w-8 h-8 rounded-full flex items-center justify-center flex-shrink-0 ${
                    message.role === 'user'
                      ...
                      : 'bg-gradient-to-br from-emerald-400 to-cyan-500 text-white font-bold text-lg'
                  }`}>
                    {message.role === 'user' ? (
            ...
            <div className="p-4 border-t border-secondary-200 dark:border-secondary-700">
              <div className="flex space-x-2">
                <input
                  ...
                  className="flex-1 px-3 py-2 border border-secondary-300 dark:border-secondary-600 rounded-lg focus:outline-none focus:ring-2 focus:ring-primary-500 bg-white dark:bg-secondary-800 text-secondary-900 dark:text-secondary-100 placeholder-secondary-500 dark:placeholder-secondary-400"
                  disabled={isLoading}
                />
                <motion.button
                  ...
                  className="px-4 py-2 bg-primary-600 hover:bg-primary-700 disabled:bg-secondary-400 disabled:cursor-not-allowed text-white rounded-lg transition-colors flex items-center justify-center"
                >
